...
一个 fork 自 GitHub 上最经典 CS 自学资源的导航仓库。每个资源都经过筛选——不贪多，只留真正值得花时间啃的。
...
| 📋 自学路线 | [coding-interview-university](https://github.com/chrysos371/coding-interview-university) | 从零到 Google L3 的完整计划 | ⭐ 300k — jwasham 八个月自学上岸的真实路线 |
...
| 方向 | 课程 | 院校/作者 | 课时 | 看点 |
|------|------|------|------|------|
| C++ | **TheCherno C++ Series** | YouTube | 280+ 集 | 从编译链接讲到游戏引擎架构，C++ 视频教程的天花板 |
| JavaScript | **JavaScript30** | Wes Bos | 30 天 | 30 天 30 个原生 JS 小项目，不调框架纯动手 |
